...
g++ -O3 -c src/main/inits.cpp -o bin/inits.o
...
# link everything
g++ -O3 bin/main.o bin/inits.o bin/engine.o bin/Player.o bin/Persona.o bin/Bullet.o bin/load.so -lsfml-graphics -lsfml-audio -lsfml-window -lsfml-system -o bin/combat
